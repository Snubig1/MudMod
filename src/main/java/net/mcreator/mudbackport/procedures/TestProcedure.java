...
public class TestProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.POTION) {
			if (((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getOrCreateTag().getString("Potion")).equals("minecraft:water")) {
				if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.COARSE_DIRT || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.DIRT) {
					{
